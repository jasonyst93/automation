...
chrome_browser.get('https://www.seleniumeasy.com/python/locating-elements-in-selenium-python') # notice the URL has changed from the video to the new demo site!
